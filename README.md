...
|  | 首頁專區、Banner SVG、子導覽功能、商品與課程細節頁、404Page |
|  | 會員系統 (註冊、登入、忘記密碼) 、 聊天室 、部落格專區 、 Gmail、Google calendar API 串接 |
| 黃昱銘 | 註冊+登入+忘記密碼頁靜態頁面切版 |

| Title | Name | Job                                   |
|-------|------|---------------------------------------|
| 陳若珈 | Navbar、Footer、品牌專區頁、購物車系統、TapPay 金流串接   |
| 何宗鴻 | 專案管理、網站部署、網站驗證優化           |
| 陶靖宜 | 教學、小遊戲頁。網頁設計、素材、企劃文案製作 |
| 柯映竹 | 首頁、關於我、驗證（前、後、資料庫）、企劃文案製作 |
| 黃奕翔 | 資料庫管理、更新，企劃文案、簡報製作       |
| 黃昱銘 | 資料庫管理、更新，企劃文案、簡報製作       |
