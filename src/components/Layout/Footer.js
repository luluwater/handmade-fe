      ...
      <Container fluid className="footer">
        ...
        <Row className="d-flex footer_row1">
          ...
          <Col
            xs={6}
            md={6}
            className="footer_detail footer_shoppingNote  order-1 order-sm-0"
          >
            <p>購物須知</p>
          </Col>
          <Col
            xs={6}
            md={4}
            className="footer_detail footer_rwd_m order-0 order-sm-0"
          >
            聯絡我們
          </Col>
          <Col
            xs={6}
            md={6}
            className="footer_cursor d-flex footer_smallWord footer_shoppingNote_detail order-2 order-sm-0"
          >
            <p className="footer_cursor">退換貨說明</p>
            <p className="footer_cursor">常見問題</p>
            <p className="footer_cursor">網站使用條款</p>
          </Col>
          <Col xs={6} md={4} className="footer_smallWord order-0 order-sm-0">
            <p>service@handmade.com</p>
          </Col>
          <Col
            xs={6}
            md={6}
            className="footer_cursor d-flex footer_smallWord footer_shoppingNote_detail order-3 order-sm-0"
          >
          ...
          <Col xs={6} md={4} className="footer_smallWord ">
            <p className="order-0 order-sm-0 ">( 03 ) - 4567899</p>
          </Col>
        </Row>
      </Container>
    </>
