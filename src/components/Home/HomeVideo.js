...
function Video() {
  return (
    <>
      <div className="home_video_box">
        <div className="home_video_2">
          <div className="home_svg_top">
            ...
            >
              <path
                d="M 0,400 C 0,400 0,200 0,200 C 140.40000000000003,195.86666666666667 280.80000000000007,191.73333333333332 445,184 C 609.1999999999999,176.26666666666668 797.2,164.93333333333334 967,167 C 1136.8,169.06666666666666 12188.4,184.53333333333333 1440,200 C 1440,200 1440,400 1440,400 Z"
                stroke="none"
                strokeWidth="0"
                fill="#F4EEE8"
                fillOpacity="1"
